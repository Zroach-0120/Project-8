...
class MyApp(ShowBase):
    def __init__(self):
        ...
        self.Wanderer1 = SpaceJamClasses.Wanderer(self.loader, self.rootAssetFolder + "/DroneDefender/DroneDefender.obj", self.render, "Drone", 6.0, self.rootAssetFolder + "/DroneDefender/octotoad1_auv.png", self.Hero, Vec3(0, 0, 0), 3.0 )
